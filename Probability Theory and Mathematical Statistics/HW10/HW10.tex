...
\begin{solution}
    ...
    \end{align*}
    因此$F_Z(z)=\frac{1}{2}+\frac{1}{2}[1-(1-\frac{z}{2})^3]=1-\frac{1}{2}(1-\frac{z}{2})^3$.

    对于$ z \ge 0 $，有$F_Z(z) = 1$.

    综上所述, $ Z $的分布函数为
    \[F_{Z}(z)=\begin{cases}0, & z<0, \\ \frac{1}{2}, & z=0, \\ 1-\frac{1}{2}(1-\frac{z}{2})^3, & 0< z < 2, \\ 1, & z \ge 2.\end{cases}\]
\end{solution}
\end{document}